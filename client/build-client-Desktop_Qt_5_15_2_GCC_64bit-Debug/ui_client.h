...
public:
    ...
    void setupUi(QWidget *Client)
    {
        ...
        gridLayout->addWidget(tableView, 1, 3, 3, 2);
        ...
        gridLayout->addWidget(listWidget, 3, 0, 2, 3);
